  ...
  return (
    <section>
        ...
        <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-6xl font-extrabold">
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#974063] to-[#FF9677]'>Hello, I'm{" "}
            </span> 
            <br></br>
            <TypeAnimation
      sequence={[
    ...
    />
        ...
        <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            "Greatness is not meant for a few chosen people, it's meant for those who persistently pursue their dreams everyday."
        </p>
        <div>
